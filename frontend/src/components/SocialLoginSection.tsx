    ...
    <section className="w-full px-6 py-10 md:px-20 md:py-14 flex flex-col items-center gap-5 md:gap-6">
      ...
      <div className="w-full max-w-md flex flex-col md:flex-row items-center gap-3 md:gap-3.5">
        ...
        <button 
          ...
          className="w-full md:w-[210px] h-12 md:h-[52px] bg-social-kakao rounded-lg flex items-center justify-center gap-2.5 hover:opacity-90 transition-all duration-200 shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isLoading === 'kakao' ? (
            <Spinner size="sm" />
          ) : (
        ...
        <button 
          ...
          disabled={isLoading !== null}
          className="w-full md:w-[210px] h-12 md:h-[52px] bg-social-google border border-midnight-border rounded-lg flex items-center justify-center gap-2.5 hover:bg-gray-50 transition-all duration-200 shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isLoading === 'google' ? (
            <Spinner size="sm" />
          ) : (
